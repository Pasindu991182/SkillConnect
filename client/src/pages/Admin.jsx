...
const handleBroadcast = (e) => {
  e.preventDefault();
  alert(`Broadcasting message: ${broadcastMessage}`);
  setBroadcastMessage('');
};
return (
<AppShell>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">{dummyUsers.length}</p>
          </div>
        </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 flex items-center">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Weekly Views</h3>
            <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">2.4k</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:text-white"
